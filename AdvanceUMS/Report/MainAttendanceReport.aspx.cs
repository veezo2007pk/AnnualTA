...
{
    public partial class MainAttendanceReport : System.Web.UI.Page
    {
            ...
            protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                {
                    var summary = _context.MainAttendanceReport(searchText).ToList();
                    CustomerListReportViewer.LocalReport.ReportPath = Server.MapPath("~/Report/RDLC/MainAttendanceReport.rdlc");
