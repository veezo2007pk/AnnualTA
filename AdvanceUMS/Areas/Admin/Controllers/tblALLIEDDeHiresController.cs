...
{
    public class tblALLIEDDeHiresController : Controller
    {
        ...
        public ActionResult Rehire(String id)
        {
            using (var transaction = db.Database.BeginTransaction())
            {
                try
                {
                    ...
                    attendaceData.intDehireStatus = 0;
                    attendaceData.intJoiningStatusCode =new Guid("D3B967C8-2F02-4937-8A79-29CABD9101D1");
        ...
        public ActionResult PopulateSupervisors(string Status)
        {
            ...
            string contractorid = new Guid(dHelper.CurrentContractorUser()).ToString();
            ...
            var list = from e in workers
                       ...
                       where e.intDehireStatus==2 && e.uqContractorCode== new Guid(contractorid) && e.Year==Status
