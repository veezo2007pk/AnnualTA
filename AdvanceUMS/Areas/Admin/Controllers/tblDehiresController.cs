...
{
    public class tblDehiresController : Controller
    {
                    ...
                    public ActionResult insertSingleOvertime(String id, int intRecommendedHrs)
        {
            ...
            using (var transaction = db.Database.BeginTransaction())
            {
             ...
             return Redirect("/admin/tblDehires");
        }


        public ActionResult DeHire(String id)
        {
            TimeZoneInfo timeZoneInfo;
            DateTime dateTime;
            //Set the time zone information to US Mountain Standard Time 
            ...
            using (var transaction = db.Database.BeginTransaction())
            {
                try
                {
                    ...
                    WorkerData.intDehireStatus = 1;
                    WorkerData.dtDehire = dateTime;
                    ...
                    //   uqDehireLog = new Guid(),
                    //   intDehireStatus = 1,
                    // uqWorkerId = new Guid(id),
        ...
        public ActionResult PopulateSupervisors(string Status)
        {
            ...
            var list = from e in workers
                       ...
                       join a in contractors on e.uqContractorCode equals a.uqContractorCode into table4
                       from a in table4.ToList()
                       join b in areas on e.uqAreaCode equals b.uqAreaCode into table5
                       from b in table5.ToList()
                       where e.uqSupervisorCode == new Guid(supervisorCode) && e.Year==Status && e.intDehireStatus!=2 && e.bolIsWorkerApproveByEng==true
